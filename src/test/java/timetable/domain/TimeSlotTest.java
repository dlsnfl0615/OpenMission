...
class TimeSlotTest {
    ...
    void 겹치지_않는_강의() {
        ...
        assertThat(timeSlot1.doesOverlap(timeSlot2)).isEqualTo(false);
        assertThat(timeSlot1.doesOverlap(timeSlot3)).isEqualTo(false);
    }
    ...
    void 겹치는_강의() {
        ...
        assertThat(timeSlot1.doesOverlap(timeSlot2)).isEqualTo(true);
    }
}